...
const SIRET_SEARCH_DESCRIPTION =
  ...
  "Geographic filtering — wildcards are NOT supported, and range queries do NOT work inside periode(). " +
  "Use the codeDepartement parameter (automatically builds the correct bare range query) " +
  "or an exact postal code:\n" +
  "  • codeDepartement='69' → codePostalEtablissement:[69000 TO 69999]\n" +
  "  • q='codePostalEtablissement:75001' for a specific postal code\n" +
  "Common period fields (must use periode()): activitePrincipaleEtablissement, " +
